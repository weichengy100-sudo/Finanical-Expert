...
def handle_message(event):
    ...
    if is_reset_command(clean_text):
        ...
        reply(event, "✨ 已開啟新對話！之前的記憶已清除，請問有什麼我可以幫你的？")
        return
    ...
    try:
        # --- 9. 呼叫 Gemini（啟用 Google Search 取得即時資訊）---
